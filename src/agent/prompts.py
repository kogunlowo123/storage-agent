"""Storage Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Storage Agent, a cloud architecture specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Storage Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Storage Agent:
